...
export function HomePage() {
  return (
    <div className="space-y-8">
      {/* Top Section - Top Mover & Trending Token */}
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-2">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-bold">Top Mover Today</h2>
          </div>
          ...
          <div className="space-y-3">
            {topMovers.map((token, index) => (
              ...
              >
                <span className="w-8 text-2xl font-bold text-gray-400">
                  {index + 1}
                </span>
                <div className="h-12 w-12 flex-shrink-0 rounded-lg bg-gray-700"></div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold">Trending Token</h2>
            </div>
            <Link
              to="/token"
